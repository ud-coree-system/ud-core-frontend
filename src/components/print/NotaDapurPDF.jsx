...
const TemplateESC = ({ data, udData, udId }) => (
    <div id={`pdf-nota-${udId}`} className="nota-container page-break font-calibri text-black bg-white">
...
const TemplatePilarPangan = ({ data, udData, udId }) => (
    <div id={`pdf-nota-${udId}`} className="nota-container page-break font-times text-black bg-white">
        {/* Watermark Logo */}
...
const TemplateASM = ({ data, udData, udId }) => (
    <div id={`pdf-nota-${udId}`} className="nota-container page-break font-trebuchet text-black bg-white">
        <div className="flex justify-between items-start mb-4">
...
const TemplateBanyuMas = ({ data, udData, udId }) => (
    <div id={`pdf-nota-${udId}`} className="nota-container page-break font-arial text-black bg-white">
        <div className="flex justify-between items-start mb-4">
            <div className="border border-black">
                <table className="text-sm">
                    <tbody>
...
const TemplateBogaFood = ({ data, udData, udId }) => (
    <div id={`pdf-nota-${udId}`} className="nota-container page-break font-arial text-black bg-white">
        ...
        <div className="flex justify-between mt-12 px-24">
            <div className="text-center">
                <div>Penerima :</div>
...
const TemplateKayaAlam = ({ data, udData, udId }) => (
    <div id={`pdf-nota-${udId}`} className="nota-container page-break font-arial text-black bg-white">
        ...
        <div className="flex justify-between mt-12 px-24 italic">
            <div className="text-center">
...
const TemplateMayurSehat = ({ data, udData, udId }) => (
    <div id={`pdf-nota-${udId}`} className="nota-container page-break font-arial text-black bg-white">
        ...
        <div className="flex justify-between mt-12 px-32 italic">
            <div className="text-center">
